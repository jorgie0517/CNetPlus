...
!!!DAPAT 7 UNDER11SCORE ANG NA EDIT MO  ( LINE 34 to 68 PASTE TO COREBABA SWITCH )
!@@@LeafSwitchONLY
config t
...
conf t
 ...
 NO ip route 10.11.0.0 255.255.0.0 200.0.0.11
...
http://docwiki.cisco.com/wiki/Cisco11IOS11Voice11Troubleshooting11and11Monitoring11--11Tcl11IVR11Troubleshooting
...
!
  voice register pool 1
    id mac 7688.9125.AA87
    number 1 dn 1
    dtmf-relay sip-notify
    username 1171 password 1171
    codec g711ulaw
!
